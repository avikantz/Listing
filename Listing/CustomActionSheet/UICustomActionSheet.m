...
-(void)showInView:(UIView *)view{
    ...
    backgroundImage = (UIImageView *)translucentView;
    //optional:
    ...
    for (NSString *buttonTitle in buttonTitles) {
		...
		[button.titleLabel setFont:[UIFont fontWithName:@"EtelkaNarrowTextPro" size:18.f]];
    ...
    if ([buttonTitles count] > 0) {
        ...
        if (_subtitle) {
            ...
            subtitle.font = [UIFont fontWithName:@"EtelkaNarrowTextPro" size:_subtitleFontSize];
        ...
        if (_title) {
            ...
            mainTitle.font = [UIFont fontWithName:@"EtelkaNarrowTextPro" size:_titleFontSize];
